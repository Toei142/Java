...
public class Lab11_02 extends JFrame implements AdjustmentListener {
    ...
    public Lab11_02() {
        ...
        c.add(new JLabel(" a : "));
        aScrollbar = new JScrollBar(JScrollBar.HORIZONTAL, 50, 10, 0, 100);
        c.add(aScrollbar);
        aScrollbar.addAdjustmentListener(this);
        c.add(new JLabel(" b : "));
        bScrollbar = new JScrollBar(JScrollBar.HORIZONTAL, 50, 10, 0, 100);
        c.add(bScrollbar);
        bScrollbar.addAdjustmentListener(this);
        c.add(new JLabel(" c : "));
        cScrollbar = new JScrollBar(JScrollBar.HORIZONTAL, 50, 10, 0, 100);
        c.add(cScrollbar);
        cScrollbar.addAdjustmentListener(this);
        c.add(new JLabel(" d : "));
        dScrollbar = new JScrollBar(JScrollBar.HORIZONTAL, 50, 10, 0, 100);
        c.add(dScrollbar);
